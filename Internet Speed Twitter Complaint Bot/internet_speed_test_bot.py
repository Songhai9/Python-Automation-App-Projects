...
class InternetSpeedTestBot:
    ...
    def get_internet_speed(self):
        ...
        # Rejecting cookies
        reject_btn = self.driver.find_element(By.ID, value='onetrust-reject-all-handler')
        reject_btn.click()
        ...
        # Ignorign ad
        back_to_results_btn = self.driver.find_element(By.LINK_TEXT, value="Back to test results")
    ...
    def tweet_at_provider(self):
        ...
        # Rejecting cookies
        refuse_cookie_btn = self.driver.find_element(By.XPATH,
                                                     value='//*[@id="layers"]/div/div/div/div/div/div[2]/button[2]/div')
        ...
        next_btn2 = self.driver.find_element(By.CSS_SELECTOR,
        ...
        tweet_input.send_keys(f'@tdsxom ton code marche bien: valeur upload = {self.up}, valeur download = {self.down}')
        send_twt_btn = self.driver.find_element(By.CSS_SELECTOR,
